...
基于rclone的crypt存储进行文件加密的保险箱GUI，使用[aardio](https://www.aardio.com/)写就，目前只支持Windows。
...
<div align="center"> 
    <img src="imgs/screenshot_tab1.jpg" width="30%" /> 
    <img src="imgs/screenshot_tab2.jpg" width="30%" /> 
    <img src="imgs/screenshot_tab3.jpg" width="30%" /> 
</div>
